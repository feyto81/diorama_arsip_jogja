...
class History_pelayanan_peserta extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('history_pelayanan_peserta/index', $data);
  }
...
'user_key' => $service_bpjs['user_key'],
    ...
    $result = $peserta->historyPelayanan($no_kartu, $tgl_awal, $tgl_akhir);
