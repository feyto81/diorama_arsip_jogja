...
class Dat_poli extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('dat_poli/index', $data);
  }

  function process()
  {
    $jenisKontrol = $this->input->post('jenisKontrol', true);
    $nomor = $this->input->post('nomor', true);
    $tglRencanaKontrol = $this->input->post('tglRencanaKontrol', true);
    //
    ...
    $result = $peserta->listPoliSpesialistik($jenisKontrol, $nomor, $tglRencanaKontrol);
