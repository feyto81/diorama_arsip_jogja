...
class Data_nomor_surat_kontrol_by_noka extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('data_nomor_surat_kontrol_by_noka/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->listSuratKontrolBerdasarkanNoKartu($Bulan, $Tahun, $Nokartu, $filter);
