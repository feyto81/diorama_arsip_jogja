...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Pencarian data Jadwal Dokter</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right mt-n2">Kode Poli BPJS <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="poli_bpjs" id="poli_bpjs" value="">
                      </div>
                    </div>
                    <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group row mt-n2">
                      <label for="menu" class="col-sm-12 col-form-label text-left">Kode Poli BPJS</label>
                      <ul class="col-sm-12 ml-4">
                        <li>ANA</li>
                      </ul>
                    </div>
                    <div class="form-group row mt-n2">
                      <label for="menu" class="col-sm-12 col-form-label text-left">Tanggal</label>
                      <ul class="col-sm-12 ml-4">
                        <li>2021-08-07</li>
                      </ul>
                    </div>
