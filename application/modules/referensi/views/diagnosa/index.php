...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Pencarian data diagnosa (ICD-10)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right mt-n2">Kode atau Nama Diagnosa <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group row mt-n2">
                      <label for="menu" class="col-sm-12 col-form-label text-left">Kode atau Nama Diagnosa</label>
