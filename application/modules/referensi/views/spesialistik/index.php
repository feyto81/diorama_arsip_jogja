...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Pencarian data spesialistik <br> (Hanya Untuk Lembar Pengajuan Klaim)</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <form id="form_submit" action="" method="post" autocomplete="off">
              <div class="card-body">
                Tidak Ada Form Input Parameter Yang Diperlukan, Klik Proses Saja
              </div>
