...
class Faskes extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('faskes/index', $data);
  }

  function process()
  {
    $kd_faskes = $this->input->post('kd_faskes', true);
    $jns_faskes = $this->input->post('jns_faskes', true);
    //
...
'user_key' => $service_bpjs['user_key'],
    ...
    $result = $peserta->faskes($kd_faskes, $jns_faskes);
