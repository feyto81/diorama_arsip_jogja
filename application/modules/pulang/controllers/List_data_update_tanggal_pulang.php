...
class List_data_update_tanggal_pulang extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('list_data_update_tanggal_pulang/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->getListDataUpdateTanggalPulang($this->input->post('bulan', true), $this->input->post('tahun', true));
