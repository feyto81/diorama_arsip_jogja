                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right mt-n2">No Sep <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="noSep" id="noSep" value="" required>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
