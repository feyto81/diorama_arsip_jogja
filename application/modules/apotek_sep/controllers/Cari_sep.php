...
class Cari_sep extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('cari_sep/index', $data);
  }
  ...
  function process()
  {
    ...
    $peserta = new Nsulistiyawan\Bpjs\Apotek\Sep($vclaim_conf);
    $result = $peserta->sep($this->input->post('noSep', true));
