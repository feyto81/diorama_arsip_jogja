...
class Data_klaim extends MY_Controller
{
  ...
  function process()
  {
    ...
    $peserta = new Nsulistiyawan\Bpjs\Apotek\Monitoring($vclaim_conf);
    $result = $peserta->klaim($this->input->post('bulan', true), $this->input->post('tahun', true), $this->input->post('jenisObat', true), $this->input->post('status', true));
