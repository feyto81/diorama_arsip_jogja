...
class antrean_belum_dilayani_per extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('antrean_belum_dilayani_per/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->antreanBelumDilayaniPer($this->input->post());
