...
class Data_induk_kecelakaan extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('data_induk_kecelakaan/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->getDataIndukKecelakaan($this->input->post('noKartu', true));
