...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?= base_url() ?>dist/frontend/images/logo_hitam.png">
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?= base_url() ?>dist/frontend/images/logo_hitam.png">
  <link rel="apple-touch-icon-precomposed" href="<?= base_url() ?>dist/frontend/images/logo_hitam.png">
          ...
          <nav class="navbar navbar-default ow-navigation">
            ...
            <div class="navbar-collapse collapse" id="navbar">
              <ul class="nav navbar-nav">
                ...
                <li><a href="<?= site_url('app/kontak_kami') ?>" title="Kontak Kami">Kontak Kami</a></li>
              </ul>
            </div>
          </nav>
        </div>
