...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?= base_url() ?>images/logos/logo_hitam.png">
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?= base_url() ?>images/logos/logo_hitam.png">
  <link rel="apple-touch-icon-precomposed" href="<?= base_url() ?>images/logos/logo_hitam.png">
