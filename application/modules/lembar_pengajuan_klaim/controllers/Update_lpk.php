...
class Update_lpk extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('lembar_pengajuan_klaim/update_lpk/index', $data);
  }
  ...
  public function ajax($id = null)
  {
    if ($id == 'add_diagnosa') {
      ...
      echo json_encode(array(
        'html' => $this->load->view('lembar_pengajuan_klaim/update_lpk/add_diagnosa', $data, true),
    ...
    if ($id == 'add_procedure') {
      ...
      //			
      echo json_encode(array(
        'html' => $this->load->view('lembar_pengajuan_klaim/update_lpk/add_procedure', $data, true),
...
'user_key' => $service_bpjs['user_key'],
    ...
    $result = $peserta->updateLPK($request);
