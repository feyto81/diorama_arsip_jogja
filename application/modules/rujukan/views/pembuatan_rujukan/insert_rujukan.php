<?php $this->load->view('_js_insert_rujukan'); ?>
      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="row pl-2">
            ...
            <h1 class="m-0 text-dark">Insert Rujukan</h1>
          </div>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        <input type="text" class="form-control form-control-sm datepicker" name="tglRujukan" id="tglRujukan" value="" required>
                      </div>
                    </div>
                    <div class="form-group row">
