<?php $this->load->view('_js_delete_rujukan'); ?>
      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="row pl-2">
            ...
            <h1 class="m-0 text-dark">Delete Rujukan</h1>
          </div>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="noRujukan" value="">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right">User Pemakai <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="user" value="">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
