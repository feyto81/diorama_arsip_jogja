                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="ppkPelayanan" value="0146R015" required>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="jnsPelayanan" value="" required>
                        <small>Jenis Pelayanan = 1. Rawat Inap, 2. Rawat Jalan</small>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right">Kelas Rawat <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="klsRawat" value="" required>
                        <small>Kelas Rawat = 1. Kelas 1, 2. Kelas 2, 3. Kelas 3</small>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="asalRujukan" value="">
                        <small>Asal Rujukan = 1. Faskes 1, 2. Faskes 2(RS)</small>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="noRujukan" value="0145U0800719P000060">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="eksekutif" value="0" required>
                        <small>Poli Eksekutif = 0. Tidak, 1. Ya</small>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right">COB <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="cob" value="0" required>
                        <small>COB = 0. Tidak, 1. Ya</small>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right">Katarak <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="katarak" value="0" required>
                        <small>Katarak = 0. Tidak, 1. Ya</small>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="lakaLantas" value="0" required>
                        <small>Jaminan Kecelakaan Lalu Lintas = 0. Tidak, 1. Ya</small>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="suplesi" value="0">
                        <small>Suplesi = 0. Tidak, 1. Ya</small>
                      </div>
                    </div>
                    <div class="form-group row">
