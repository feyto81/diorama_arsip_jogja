...
class Riwayat_pelayanan_obat extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('riwayat_pelayanan_obat/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->riwayatobat($this->input->post('tglAwal', true), $this->input->post('tglAkhir', true), $this->input->post('noKartu', true));
