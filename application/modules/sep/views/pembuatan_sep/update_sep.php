<?php $this->load->view('_js_update_sep'); ?>
      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="row pl-2">
            ...
            <h1 class="m-0 text-dark">Update SEP versi 1.1</h1>
          </div>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="noSep" value="1120R0011120V003969" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label for="menu" class="col-sm-4 col-form-label text-right">Nomor Surat Kontrol <span class="text-danger">*</span></label>
                      <div class="col-sm-7">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        ...
                        <small>Nomor Telepon Peserta/Pasien</small>
                      </div>
                    </div>
                    <div class="form-group row">
