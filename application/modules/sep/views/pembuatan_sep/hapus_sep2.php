<?php $this->load->view('_js_hapus_sep2'); ?>
      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <div class="row pl-2">
            ...
            <h1 class="m-0 text-dark">Hapus Data SEP Versi 2.0</h1>
          </div>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" name="noSep" value="1120R0011021V000001" required>
                      </div>
                    </div>
                    <div class="form-group row">
