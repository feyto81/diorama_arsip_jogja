...
class Get_list_fingerprint extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('get_list_fingerprint/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->getListFingerprint($this->input->post('tglPelayanan', true));
