...
class Get_fingerprint extends MY_Controller
{
  ...
  public function index()
  {
    ...
    $data['menu'] = $this->menu;
    $this->render('get_fingerprint/index', $data);
  }
  ...
  function process()
  {
    ...
    $result = $peserta->getFingerprint($this->input->post('noKartu', true), $this->input->post('tglPelayanan', true));
