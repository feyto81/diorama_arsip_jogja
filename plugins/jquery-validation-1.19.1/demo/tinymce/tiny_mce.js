  ...
  tinymce.create("tinymce.util.URI", {
    URI: function (u, s) {
      ...
      if (u.indexOf("/") === 0 && u.indexOf("//") !== 0)
        u =
          (s.base_uri ? s.base_uri.protocol || "http" : "http") +
          "://mce_host" +
          u;
      if (u.indexOf(":/") === -1 && u.indexOf("//") !== 0)
        u =
          (s.base_uri.protocol || "http") +
          "://mce_host" +
    ...
    toRelative: function (u) {
      ...
      if (
        (u.host != "mce_host" && t.host != u.host && u.host) ||
        t.port != u.port ||
...
tinymce.create("static tinymce.util.JSON", {
  serialize: function (o) {
    ...
    if (t == "string") {
      ...
      return (
        '"' +
        o.replace(/([\u0080-\uFFFF\x00-\x1f\"])/g, function (a, b) {
          i = v.indexOf(b);
  ...
  tinymce.create("tinymce.util.JSONRequest", {
    ...
    send: function (o) {
      ...
      o.success = function (c, x) {
        ...
        if (c.error) ecb.call(o.error_scope || o.scope, c.error, x);
        else scb.call(o.success_scope || o.scope, c.result);
      };
  ...
  tinymce.create("tinymce.dom.DOMUtils", {
    ...
    DOMUtils: function (d, s) {
      ...
      this.settings = s = tinymce.extend(
        { keep_values: false, hex_colors: 1, process_html: 1 },
        s
      );
      if (tinymce.isIE6) {
        try {
      ...
      if (is(f, "string")) {
        ...
        f = function (n) {
          ...
          each(na.split(","), function (v) {
            if (
              n.nodeType == 1 &&
              ((se.strict && n.nodeName.toUpperCase() == v) ||
                n.nodeName.toUpperCase() == v)
            ) {
              s = true;
              return false;
            }
    ...
    select: function (pa, s) {
      ...
      each(o, function (n) {
        if (isIE) n.removeAttribute("mce_save");
    ...
    setStyle: function (n, na, v) {
      ...
      return t.run(n, function (e) {
        ...
        if (
          t.pixelStyles.test(na) &&
          (tinymce.is(v, "number") || /^[\-0-9\.]+$/.test(v))
        )
          v += "px";
        switch (na) {
          case "opacity":
      ...
      return this.run(e, function (e) {
        ...
        switch (n) {
          case "style":
            ...
            if (s.keep_values) {
              if (v && !t._isRes(v)) e.setAttribute("mce_style", v, 2);
    ...
    parseStyle: function (st) {
      ...
      each(st.split(";"), function (v) {
        ...
        if (v) {
          ...
          if (s.url_converter) {
            sv = sv.replace(/url\([\'\"]?([^\)\'\"]+)[\'\"]?\)/g, function (
              x,
              c
            ) {
              return (
                "url(" +
                s.url_converter.call(
                  s.url_converter_scope || t,
                  t.decode(c),
                  "style",
                  null
                ) +
    ...
    isHidden: function (e) {
      e = this.get(e);
      return (
        !e || e.style.display == "none" || this.getStyle(e, "display") == "none"
      );
    },
    uniqueId: function (p) {
            ...
            if (t.settings.fix_ie_paragraphs) {
              ...
              for (i = nl.length - 1; i >= 0; i--) {
                ...
                if (n.mce_tmp) {
                  ...
                  n.cloneNode(false).outerHTML.replace(
                    /([a-z0-9\-_]+)=/gi,
                    function (a, b) {
                      var v;
                      if (b !== "mce_tmp") {
    ...
    processHTML: function (h) {
      ...
      if (s.keep_values) {
        if (/<script|style/.test(h)) {
          ...
          h = h.replace(/<script([^>]+|)>([\s\S]*?)<\/script>/g, function (
            v,
            a,
            b
          ) {
          ...
          h = h.replace(/<style([^>]+|)>([\s\S]*?)<\/style>/g, function (
            v,
            a,
            b
          ) {
    ...
    isBlock: function (n) {
      ...
      n = n.nodeName || n;
      return /^(H[1-6]|HR|P|DIV|ADDRESS|PRE|FORM|TABLE|LI|OL|UL|TD|CAPTION|BLOCKQUOTE|CENTER|DL|DT|DD|DIR|FIELDSET|NOSCRIPT|NOFRAMES|MENU|ISINDEX|SAMP)$/.test(
        n
      );
    },
    ...
    toHex: function (s) {
      var c = /^\s*rgb\s*?\(\s*?([0-9]+)\s*?,\s*?([0-9]+)\s*?,\s*?([0-9]+)\s*?\)\s*$/i.exec(
        s
      );
      function hex(s) {
    ...
    getAttribs: function (n) {
      ...
      if (isIE) {
        ...
        n.cloneNode(false).outerHTML.replace(/([a-z0-9\:\-_]+)=/gi, function (
          a,
          b
        ) {
    ...
    _isRes: function (c) {
      return (
        /^(top|left|bottom|right|width|height)/i.test(c) ||
...
(function () {
  ...
  tinymce.create("static tinymce.dom.Event", {
    ...
    _add: function (o, n, f) {
      if (o.attachEvent) o.attachEvent("on" + n, f);
      else if (o.addEventListener) o.addEventListener(n, f, false);
      else o["on" + n] = f;
    },
  ...
  tinymce.create("tinymce.dom.Selection", {
    ...
    getContent: function (s) {
      ...
      if (s.format == "text")
        return t.isCollapsed()
          ? ""
          : r.text || (se.toString ? se.toString() : "");
      if (r.cloneContents) {
        n = r.cloneContents();
    ...
    getBookmark: function (si) {
      ...
      function getPos(r, sn, en) {
        var w = t.dom.doc.createTreeWalker(
            r,
    ...
    select: function (n, c) {
      ...
      function first(n) {
        return n
          ? d.createTreeWalker(n, NodeFilter.SHOW_TEXT, null, false).nextNode()
          : null;
      }
      function last(n) {
        var c, o, w;
    ...
    getRng: function () {
      ...
      if (!r)
        r = isIE
          ? t.win.document.body.createTextRange()
          : t.win.document.createRange();
      return r;
    },
    setRng: function (r) {
...
(function () {
  ...
  tinymce.create("tinymce.dom.Serializer", {
      ...
      if (s.fix_table_elements) {
        t.onPreProcess.add(function (se, o) {
          each(t.dom.select("table", o.node), function (e) {
            var pa = t.dom.getParent(e, "H1,H2,H3,H4,H5,H6,P"),
              pa2,
              n,
              tm,
              pl = [],
    ...
    addValidChildRules: function (s) {
      ...
      bloc =
        "H[1-6]|P|DIV|ADDRESS|PRE|FORM|TABLE|LI|OL|UL|TD|CAPTION|BLOCKQUOTE|CENTER|DL|DT|DD|DIR|FIELDSET|FORM|NOSCRIPT|NOFRAMES|MENU|ISINDEX|SAMP";
    ...
    addRules: function (s) {
      ...
      t.validElementsRE = new RegExp(
        "^(" + wildcardToRE(s.toLowerCase()) + ")$"
      );
    },
    findRule: function (n) {
      var t = this,
    ...
    _serializeNode: function (n, inn) {
      ...
      if (!s.node_filter || s.node_filter(n)) {
        switch (n.nodeType) {
          case 1:
            ...
            if (
              !t.validElementsRE.test(nn) ||
              (t.invalidElementsRE && t.invalidElementsRE.test(nn)) ||
              inn
            ) {
              iv = true;
              break;
      ...
      if (!iv) {
        if (hc || !s.closed.test(nn)) w.writeFullEndElement();
        else w.writeEndElement();
      }
    },
    _protect: function (o) {
      var t = this;
      ...
      each(o.patterns, function (p) {
        o.content = dec(
          enc(o.content).replace(p.pattern, function (x, a, b, c) {
            b = dec(b);
    ...
    _setup: function () {
      ...
      if (s.invalid_elements)
        t.invalidElementsRE = new RegExp(
          "^(" +
      ...
      each(sc, function (o) {
        ...
        if (!Event.domLoaded && !t.settings.strict_mode) {
          ...
          if (cb || o.func) {
            ...
            ol +=
              "tinymce.dom.ScriptLoader._onLoad(this,'" + u + "'," + ix + ');"';
          }
          document.write(
            '<script type="text/javascript" src="' +
              tinymce._addVer(u) +
...
(function () {
  ...
  tinymce.create("tinymce.ui.Control", {
    ...
    setState: function (c, s) {
      ...
      if (s) DOM.addClass(n, c);
      else DOM.removeClass(n, c);
    },
    isRendered: function () {
...
(function () {
  ...
  tinymce.create("tinymce.ui.DropMenu:tinymce.ui.Menu", {
    ...
    update: function () {
      ...
      th = s.max_height
        ? Math.min(tb.clientHeight, s.max_height)
        : tb.clientHeight;
      if (!DOM.boxModel) t.element.setStyles({ width: tw + 2, height: th + 2 });
      else t.element.setStyles({ width: tw, height: th });
    ...
    showMenu: function (x, y, px) {
      ...
      t.mouseClickFunc = Event.add(co, "click", function (e) {
        ...
        if (
          e &&
          (e = DOM.getParent(e, "TR")) &&
          !DOM.hasClass(e, cp + "ItemSub")
        ) {
          m = t.items[e.id];
    ...
    _add: function (tb, o) {
      ...
      n = DOM.add(
        n,
        s.element || "span",
        { class: "mceText", title: o.settings.title },
        o.settings.title
      );
  ...
  tinymce.create("tinymce.ui.ListBox:tinymce.ui.Control", {
    ...
    hideMenu: function (e) {
      ...
      if (
        e &&
        e.type == "mousedown" &&
        (e.target.id == t.id + "_text" || e.target.id == t.id + "_open")
      )
        return;
      if (
        !e ||
        !DOM.getParent(e.target, function (n) {
      ...
      Event.add(t.id + "_text", "focus", function (e) {
        if (!t._focused) {
          t.keyDownHandler = Event.add(t.id + "_text", "keydown", function (e) {
            ...
            if (kc == 38) v = t.items[idx - 1];
            else if (kc == 40) v = t.items[idx + 1];
            else if (kc == 13) {
              v = t.selectedValue;
  ...
  tinymce.create("tinymce.ui.MenuButton:tinymce.ui.Button", {
    ...
    hideMenu: function (e) {
      ...
      if (
        e &&
        e.type == "mousedown" &&
        DOM.getParent(e.target, function (e) {
...
(function () {
  ...
  tinymce.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
    ...
    renderMenu: function () {
      ...
      tb = DOM.add(n, "tbody");
      i = 0;
      each(is(s.colors, "array") ? s.colors : s.colors.split(","), function (
        c
      ) {
        c = c.replace(/^#/, "");
        if (!i--) {
...
tinymce.create("tinymce.ui.Toolbar:tinymce.ui.Container", {
  renderHTML: function () {
    ...
    for (i = 0; i < cl.length; i++) {
      ...
      if (i === 0) {
        c = "mceToolbarStart";
        if (co.Button) c += " mceToolbarStartButton";
        else if (co.SplitButton) c += " mceToolbarStartSplitButton";
        else if (co.ListBox) c += " mceToolbarStartListBox";
        h += dom.createHTML(
          "td",
          { class: c },
    ...
    c = "mceToolbarEnd";
    if (co.Button) c += " mceToolbarEndButton";
    else if (co.SplitButton) c += " mceToolbarEndSplitButton";
    else if (co.ListBox) c += " mceToolbarEndListBox";
    h += dom.createHTML(
      "td",
      { class: c },
      dom.createHTML("span", null, "<!-- IE -->")
  ...
  tinymce.create("tinymce.AddOnManager", {
    ...
    requireLangPack: function (n) {
      ...
      if (s && s.language) {
        ...
        else tinymce.ScriptLoader.add(u);
      }
    },
    add: function (id, o) {
      this.items.push(o);
...
(function () {
  ...
  tinymce.create("static tinymce.EditorManager", {
    ...
    preInit: function () {
      var t = this,
        lo = window.location;
      tinymce.documentBaseURL = lo.href
        .replace(/[\?#].*$/, "")
        .replace(/[\/\\][^\/]+$/, "");
      if (!/[\/\\]$/.test(tinymce.documentBaseURL))
        tinymce.documentBaseURL += "/";
      tinymce.baseURL = new tinymce.util.URI(
        tinymce.documentBaseURL
      ).toAbsolute(tinymce.baseURL);
      tinymce.EditorManager.baseURI = new tinymce.util.URI(tinymce.baseURL);
      if (document.domain && lo.hostname != document.domain)
        tinymce.relaxedDomain = document.domain;
      if (
        !tinymce.relaxedDomain &&
        tinymce.EditorManager.baseURI.host != lo.hostname &&
        lo.hostname
      )
        document.domain = tinymce.relaxedDomain = lo.hostname.replace(
          /.*\.(.+\..+)$/,
          "$1"
        );
    ...
    init: function (s) {
      ...
      if (!Event.domLoaded && !s.strict_loading_mode) {
        ...
        if (s.theme && s.theme.charAt(0) != "-" && !ThemeManager.urls[s.theme])
          ThemeManager.load(
            s.theme,
            "themes/" + s.theme + "/editor_template" + tinymce.suffix + ".js"
          );
        if (s.plugins) {
          ...
          if (tinymce.inArray(pl, "compat2x") != -1)
            PluginManager.load(
              "compat2x",
              "plugins/compat2x/editor_plugin" + tinymce.suffix + ".js"
            );
          each(pl, function (v) {
            if (v && v.charAt(0) != "-" && !PluginManager.urls[v]) {
              ...
              PluginManager.load(
                v,
                "plugins/" + v + "/editor_plugin" + tinymce.suffix + ".js"
              );
            }
          });
        }
...
(function () {
  ...
  var is = tinymce.is,
    ThemeManager = tinymce.ThemeManager,
    PluginManager = tinymce.PluginManager,
    EditorManager = tinymce.EditorManager;
  ...
  tinymce.create("tinymce.Editor", {
    Editor: function (id, s) {
      ...
      t.documentBaseURI = new tinymce.util.URI(
        s.document_base_url || tinymce.documentBaseURL,
      ...
      function loadScripts() {
        ...
        each(explode(s.plugins), function (p) {
          if (p && p.charAt(0) != "-" && !PluginManager.urls[p]) {
            ...
            PluginManager.load(
              p,
              "plugins/" + p + "/editor_plugin" + tinymce.suffix + ".js"
            );
          }
        });
          ...
          if (s.ask) {
            function ask() {
              window.setTimeout(function () {
                ...
                t.windowManager.confirm(t.getLang("edit_confirm"), function (
                  s
                ) {
                  if (s) t.init();
                });
    ...
    init: function () {
      ...
      each(explode(s.plugins.replace(/\-/g, "")), function (p) {
        var c = PluginManager.get(p),
          u =
            PluginManager.urls[p] || tinymce.documentBaseURL.replace(/\/$/, ""),
          po;
        if (c) {
          po = new c(t, u);
          t.plugins[p] = po;
      ...
      if (s.popup_css !== false) {
        if (s.popup_css)
          ...
          s.popup_css = t.baseURI.toAbsolute(
            "themes/" + s.theme + "/skins/" + s.skin + "/dialog.css"
          );
      }
      if (s.popup_css_add)
      ...
      h =
        (o.iframeHeight || h) +
        (typeof h == "number" ? o.deltaHeight || 0 : "");
      if (h < 100) h = 100;
      t.iframeHTML =
        s.doctype +
    ...
    setupIframe: function () {
      ...
      if (s.verify_css_classes) {
        t.serializer.attribValueFilter = function (n, v) {
          ...
          if (n == "class") {
            ...
            return !t.classesRE ||
              /(\bmceItem\w+\b|\bmceTemp\w+\b)/g.test(v) ||
              t.classesRE.test(v)
              ? v
              : "";
          }
      ...
      setTimeout(function () {
        ...
        t.load({
          initial: true,
          format: s.cleanup_on_startup ? "html" : "raw",
        });
    ...
    focus: function (sf) {
      var oed,
        t = this,
        ce = t.settings.content_editable;
      if (!sf) {
    ...
    getLang: function (n, dv) {
      return (
        EditorManager.i18n[(this.settings.language || "en") + "." + n] ||
        (is(dv) ? dv : "{#" + n + "}")
      );
    },
    ...
    nodeChanged: function (o) {
      var t = this,
        s = t.selection,
        n = s.getNode() || t.getBody();
      if (t.initialized) {
        t.onNodeChange.dispatch(
          t,
          o ? o.controlManager || t.controlManager : t.controlManager,
          isIE && n.ownerDocument != t.getDoc() ? t.getBody() : n,
          s.isCollapsed(),
          o
        );
      }
    ...
    execCommand: function (cmd, ui, val, a) {
      var t = this,
        ...
        st;
      if (
        !/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint|SelectAll)$/.test(
          cmd
        ) &&
        (!a || !a.skip_focus)
      )
      ...
      each(t.dom.select("table,a", e), function (e) {
        ...
        switch (e.nodeName) {
          case "TABLE":
            ...
            if (!v || v == "0") {
              if (t.hasVisual) t.dom.addClass(e, s.visual_table_class);
              else t.dom.removeClass(e, s.visual_table_class);
            }
            return;
          case "A":
            v = t.dom.getAttrib(e, "name");
            if (v) {
              if (t.hasVisual) t.dom.addClass(e, "mceItemAnchor");
              else t.dom.removeClass(e, "mceItemAnchor");
            }
            return;
        }
      });
    ...
    _addEvents: function () {
        ...
        switch (k) {
          ...
          case "paste":
            Event.add(t.getBody(), k, function (e) {
              var tx, h, el, r;
              if (e.clipboardData) tx = e.clipboardData.getData("text/plain");
          ...
          case "reset":
            Event.add(
              t.getElement().form || DOM.getParent(t.id, "form"),
              k,
              eventHandler
            );
            break;
          default:
            Event.add(
              s.content_editable ? t.getBody() : t.getDoc(),
              k,
              eventHandler
            );
        }
      ...
      Event.add(
        s.content_editable ? t.getBody() : isGecko ? t.getDoc() : t.getWin(),
        "focus",
        function (e) {
          t.focus(true);
        }
      ...
      if (t.getParam("tab_focus")) {
        ...
        function tabHandler(ed, e) {
          ...
          if (e.keyCode === 9) {
            ...
            if (e.shiftKey) {
              if (v[0] == ":prev") el = find(-1);
              else el = DOM.get(v[0]);
            } else {
              if (v[1] == ":next") el = find(1);
              else el = DOM.get(v[1]);
            }
            if (el) {
              if ((ed = EditorManager.get(el.id || el.name))) ed.focus();
              else
                window.setTimeout(function () {
                  window.focus();
                  el.focus();
      ...
      if (s.custom_shortcuts) {
        ...
        function find(e) {
          ...
          each(t.shortcuts, function (o) {
            if (tinymce.isMac && o.ctrl != e.metaKey) return;
            else if (!tinymce.isMac && o.ctrl != e.ctrlKey) return;
            if (o.alt != e.altKey) return;
            if (o.shift != e.shiftKey) return;
            if (
              e.keyCode == o.keyCode ||
              (e.charCode && e.charCode == o.charCode)
            ) {
              v = o;
              return false;
            }
        ...
        if (o.get) {
            ...
            switch (n.nodeName) {
              ...
              case "STRIKE":
                n.style.textDecoration =
                  n.nodeName == "U" ? "underline" : "line-through";
          ...
          each(t.dom.select("table,span", o.node).reverse(), function (n) {
            if (n.nodeName == "TABLE") {
              ...
              if (n.style.textDecoration == "underline") na = "u";
              else if (n.style.textDecoration == "line-through") na = "strike";
              else na = "";
              if (na) {
                n.style.textDecoration = "";
                dom.setAttrib(n, "mce_style", "");
    ...
    _convertFonts: function () {
      ...
      function process(no) {
        ...
        for (x = nl.length - 1; x >= 0; x--) {
          ...
          if (n.size) {
            if (sl) dom.setStyle(sp, "fontSize", sl[parseInt(n.size) - 1]);
            else dom.setAttrib(sp, "class", cl[parseInt(n.size) - 1]);
          }
...
(function () {
  var each = tinymce.each,
    ...
    isWebKit = tinymce.isWebKit;
  function isBlock(n) {
    return /^(H[1-6]|HR|P|DIV|ADDRESS|PRE|FORM|TABLE|OL|UL|TD|CAPTION|BLOCKQUOTE|CENTER|DL|DT|DD|DIR|FIELDSET|NOSCRIPT|NOFRAMES|MENU|ISINDEX|SAMP)$/.test(
      n.nodeName
    );
  }
  tinymce.create("tinymce.EditorCommands", {
      ...
      switch (cmd) {
        ...
        case "Paste":
          try {
            ...
            if (isGecko) {
              ed.windowManager.confirm(ed.getLang("clipboard_msg"), function (
                s
              ) {
                if (s)
                  window.open(
      ...
      if (
        ...
        each(this._getSelectedBlocks(), function (e) {
          d.setStyle(
            e,
            "paddingLeft",
            parseInt(e.style.paddingLeft || 0) + iv + iu
          );
        });
        return;
      }
    ...
    mceReplaceContent: function (u, v) {
      ...
      s.setContent(
        v.replace(/\{\$selection\}/g, s.getContent({ format: "text" }))
      );
    },
    mceInsertLink: function (u, v) {
      var ed = this.editor,
        s = ed.selection,
        e = ed.dom.getParent(s.getNode(), "A");
    ...
    FontName: function (u, v) {
      ...
      if (!v) {
        ...
        else ed.getDoc().execCommand("FontName", false, v);
      }
    },
    FontSize: function (u, v) {
      ...
      if (v >= 1 && v <= 7) ed.getDoc().execCommand("FontSize", false, v);
      else this._applyInlineStyle("span", { style: { fontSize: v } });
    },
    queryCommandValue: function (c) {
    ...
    mceJustify: function (c, v) {
      ...
      if (nn == "IMG") {
        ...
        if (v == "center") {
          ...
          if (!bl || bl.childNodes.length > 1) {
            ...
            if (bl) dom.insertAfter(nb, bl);
            else dom.insertAfter(nb, n);
            dom.remove(n);
            n = nb.firstChild;
            bl = nb;
          }
      ...
      if (ed.settings.inline_styles && ed.settings.forced_root_block) {
        if (rm) v = "";
        each(
          this._getSelectedBlocks(
            dom.getParent(se.getStart(), dom.isBlock),
            dom.getParent(se.getEnd(), dom.isBlock)
          ),
          function (e) {
    ...
    getSelectedElement: function () {
      ...
      if (isIE) {
        ...
        if (sc == ec) {
          ...
          if (
            r1.compareEndPoints("StartToStart", r) == 0 &&
            r1.compareEndPoints("EndToEnd", r) == 0
          )
      ...
      if (isWebKit)
        s.setContent(
          s
            ...
            .replace(
              /(<(span|b|i|strong|em|strike) [^>]+>|<(span|b|i|strong|em|strike)>|<\/(span|b|i|strong|em|strike)>|)/g,
              ""
            ),
          { format: "raw" }
        );
      else ed.getDoc().execCommand("RemoveFormat", false, null);
    ...
    mceSetStyleInfo: function (u, v) {
      ...
      each(dom.select(nn).reverse(), function (n) {
        if (
          dom.getAttrib(n, "mce_new") ||
          (dom.getAttribs(n).length <= 1 && n.className === "")
        ) {
    ...
    queryStateOutdent: function () {
      ...
      if (ed.settings.inline_styles) {
        if (
          (n = ed.dom.getParent(ed.selection.getStart(), ed.dom.isBlock)) &&
          parseInt(n.style.paddingLeft) > 0
        )
          return true;
        if (
          (n = ed.dom.getParent(ed.selection.getEnd(), ed.dom.isBlock)) &&
          parseInt(n.style.paddingLeft) > 0
        )
          return true;
      }
    ...
    mceBlockQuote: function () {
      ...
      if ((bq = getBQ(sb))) {
        if (
          sb != eb ||
          sb.childNodes.length > 1 ||
          (sb.childNodes.length == 1 && sb.firstChild.nodeName != "BR")
        )
          bm = s.getBookmark();
        if (getBQ(eb)) {
      ...
      if (
        ...
        bm = s.getBookmark();
      each(
        t._getSelectedBlocks(getBQ(s.getStart()), getBQ(s.getEnd())),
        function (e) {
    ...
    _applyInlineStyle: function (na, at, op) {
      ...
      function replaceFonts() {
        var bm;
        each(
          dom.select(tinymce.isWebKit && !tinymce.isAir ? "span" : "font"),
          function (n) {
        ...
        each(dom.select(na).reverse(), function (n) {
          ...
          each(dom.getAttribs(n), function (an) {
            if (
              an.nodeName.substring(0, 1) != "_" &&
              dom.getAttrib(n, an.nodeName) != ""
            ) {
              c++;
            }
          });
...
tinymce.create("tinymce.UndoManager", {
  ...
  add: function (l) {
    ...
    la =
      t.data[
        t.index > 0 && (t.index == 0 || t.index == t.data.length)
          ? t.index - 1
          : t.index
      ];
...
(function () {
  ...
  tinymce.create("tinymce.ForceBlocks", {
    ForceBlocks: function (ed) {
      ...
      t.rePadd = new RegExp(
        "<p( )([^>]+)><\\/p>|<p( )([^>]+)\\/>|<p( )([^>]+)>\\s+<\\/p>|<p><\\/p>|<p\\/>|<p>\\s+<\\/p>".replace(
          /p/g,
          elm
        ),
        "gi"
      ...
      t.reBR2Nbsp = new RegExp(
        "<p( )([^>]+)>\\s*<br \\/>\\s*<\\/p>|<p>\\s*<br \\/>\\s*<\\/p>".replace(
          /p/g,
          elm
        ),
        "gi"
      );
      t.reTrailBr = new RegExp(
        "\\s*<br \\/>\\s*<\\/p>".replace(/p/g, elm),
        "gi"
      );
      function padd(ed, o) {
    ...
    find: function (n, t, s) {
      var ed = this.editor,
        w = ed.getDoc().createTreeWalker(n, 4, null, false),
        c = -1;
      while ((n = w.nextNode())) {
        c++;
        if (t == 0 && n == s) return c;
      ...
      for (i = nl.length - 1; i >= 0; i--) {
        ...
        if (nx.nodeType == 3 || (!t.dom.isBlock(nx) && nx.nodeType != 8)) {
          if (!bl) {
              ...
              if (si == -2 && r) {
                if (!isIE) {
                  if (
                    ...
                    if (
                      ed.dom.getParent(r.startContainer, function (e) {
                        return e === b;
                      })
                    ) {
                      so = r.startOffset;
            ...
            if (bl.hasChildNodes()) bl.insertBefore(nx, bl.firstChild);
            else bl.appendChild(nx);
          }
        } else bl = null;
      }
      if (si != -2) {
        if (!isIE) {
          ...
          r = d.createRange();
          if (si != -1) r.setStart(t.find(b, 1, si), so);
          else r.setStart(bl, 0);
          if (ei != -1) r.setEnd(t.find(b, 1, ei), eo);
          else r.setEnd(bl, 0);
          if (s) {
            s.removeAllRanges();
            s.addRange(r);
    ...
    insertPara: function (e) {
      ...
      if (
        /(TD|TABLE|TH|CAPTION)/.test(bn) ||
        (sb && bn == "DIV" && /left|right/gi.test(sb.style.cssFloat))
      ) {
        bn = se.element;
        sb = eb = null;
      }
      ...
      if (sc.nodeName == bn) rb.setStart(sc, 0);
      else rb.setStartBefore(sc);
      rb.setEnd(sn, so);
      ...
      if (!sc.previousSibling && sc.parentNode.nodeName == bn) {
        ...
        else r.setStart(rb.startContainer, rb.startOffset);
      }
      if (!ec.nextSibling && ec.parentNode.nodeName == bn)
        r.setEndAfter(ec.parentNode);
      else r.setEnd(ra.endContainer, ra.endOffset);
      r.deleteContents();
    ...
    backspaceDelete: function (e, bs) {
      ...
      if (sc && ed.dom.isBlock(sc) && !/^(TD|TH)$/.test(sc.nodeName) && bs) {
        if (
          sc.childNodes.length == 0 ||
          (sc.childNodes.length == 1 && sc.firstChild.nodeName == "BR")
        ) {
          n = sc;
          while ((n = n.previousSibling) && !ed.dom.isBlock(n));
          if (n) {
            if (sc != b.firstChild) {
              w = ed.dom.doc.createTreeWalker(
                n,
                NodeFilter.SHOW_TEXT,
                null,
                false
  ...
  tinymce.create("tinymce.ControlManager", {
    ...
    createDropMenu: function (id, s, cc) {
      var t = this,
        ...
        cls;
      s = extend(
        { class: "mceDropDown", constrain: ed.settings.constrain_menu },
        s
      );
  ...
  tinymce.create("tinymce.WindowManager", {
    ...
    open: function (s, p) {
      var t = this,
        ...
        x,
        y,
        mo = t.editor.settings.dialog_type == "modal",
        w,
        sw,
        sh,
